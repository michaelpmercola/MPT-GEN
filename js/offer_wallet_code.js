...
if (offer_wallet_lang2) {
    ...
    const offer_wallet_code = `<!-- English Wallet -->\n<li><a onclick="s_objectID='Popup Offer - ${offer_wallet_field1}';" href="${offer_wallet_field2}?utm_source=banner&amp;utm_medium=int&amp;utm_campaign=${offer_wallet_field3}&amp;utm_content=shopwallet_popup&amp;utm_term=slot${offer_wallet_field1}"><img alt="${offer_wallet_field4}" src="${offer_wallet_field5}" /></a></li>\n\n<li class="item"><a onclick="s_objectID='Popup Offer - ${offer_wallet_field1}';" href="${offer_wallet_field2}?utm_source=banner&amp;utm_medium=int&amp;utm_campaign=${offer_wallet_field3}&amp;utm_content=shopwallet_popup&amp;utm_term=slot${offer_wallet_field1}"><img alt="${offer_wallet_field4}" src="${offer_wallet_field5}" /></a></li>\n\n<!-- Spanish Wallet -->\n<li><a onclick="s_objectID='Popup Offer - ${offer_wallet_field1}';" href="${updatedUrl}?utm_source=banner&amp;utm_medium=int&amp;utm_campaign=${offer_wallet_field3}&amp;utm_content=esshopwallet_popup&amp;utm_term=slot${offer_wallet_field1}&amp;langId=es"><img alt="${offer_wallet_field4}" src="${offer_wallet_field5}" /></a></li>\n\n<li class="item"><a onclick="s_objectID='Popup Offer - ${offer_wallet_field1}';" href="${updatedUrl}?utm_source=banner&amp;utm_medium=int&amp;utm_campaign=${offer_wallet_field3}&amp;utm_content=esshopwallet_popup&amp;utm_term=slot${offer_wallet_field1}&amp;langId=es"><img alt="${offer_wallet_field4}" src="${offer_wallet_field5}" /></a></li>`;
    ...
    const offer_wallet_code = `<!-- English Wallet -->\n<li><a onclick="s_objectID='Popup Offer - ${offer_wallet_field1}';" href="${offer_wallet_field2}?utm_source=banner&amp;utm_medium=int&amp;utm_campaign=${offer_wallet_field3}&amp;utm_content=shopwallet_popup&amp;utm_term=slot${offer_wallet_field1}"><img alt="${offer_wallet_field4}" src="${offer_wallet_field5}" /></a></li>\n\n<li class="item"><a onclick="s_objectID='Popup Offer - ${offer_wallet_field1}';" href="${offer_wallet_field2}?utm_source=banner&amp;utm_medium=int&amp;utm_campaign=${offer_wallet_field3}&amp;utm_content=shopwallet_popup&amp;utm_term=slot${offer_wallet_field1}"><img alt="${offer_wallet_field4}" src="${offer_wallet_field5}" /></a></li>\n\n<!-- Spanish Wallet -->\n<li><a onclick="s_objectID='Popup Offer - ${offer_wallet_field1}';" href="${updatedUrl}?utm_source=banner&amp;utm_medium=int&amp;utm_campaign=${offer_wallet_field3}&amp;utm_content=esshopwallet_popup&amp;utm_term=slot${offer_wallet_field1}&amp;langId=es"><img alt="${offer_wallet_field4}" src="${offer_wallet_field6}" /></a></li>\n\n<li class="item"><a onclick="s_objectID='Popup Offer - ${offer_wallet_field1}';" href="${updatedUrl}?utm_source=banner&amp;utm_medium=int&amp;utm_campaign=${offer_wallet_field3}&amp;utm_content=esshopwallet_popup&amp;utm_term=slot${offer_wallet_field1}&amp;langId=es"><img alt="${offer_wallet_field4}" src="${offer_wallet_field6}" /></a></li>`;
    document.getElementById('offer_wallet_output').textContent = offer_wallet_code;

}else{
    const offer_wallet_code = `<li><a onclick="s_objectID='Popup Offer - ${offer_wallet_field1}';" href="${offer_wallet_field2}?utm_source=banner&amp;utm_medium=int&amp;utm_campaign=${offer_wallet_field3}&amp;utm_content=shopwallet_popup&amp;utm_term=slot${offer_wallet_field1}"><img alt="${offer_wallet_field4}" src="${offer_wallet_field5}" /></a></li>\n\n<li class="item"><a onclick="s_objectID='Popup Offer - ${offer_wallet_field1}';" href="${offer_wallet_field2}?utm_source=banner&amp;utm_medium=int&amp;utm_campaign=${offer_wallet_field3}&amp;utm_content=shopwallet_popup&amp;utm_term=slot${offer_wallet_field1}"><img alt="${offer_wallet_field4}" src="${offer_wallet_field5}" /></a></li>`;
    document.getElementById('offer_wallet_output').textContent = offer_wallet_code;    
}
