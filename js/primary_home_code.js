...
if (primary_home_lang2) {
    ...
    const primary_home_code = `<!-- EN Primary Banner -->\n<div class="item" region_id="Shop Banner Slot ${primary_home_field1}">\n<div id="hpdesk"><a onclick="s_objectID='Shop Banner Slot ${primary_home_field1}';" href="${primary_home_field2}?utm_source=banner&amp;utm_medium=int&amp;utm_campaign=${primary_home_field3}&amp;utm_content=shoptop&amp;utm_term=slot${primary_home_field1}"> <img alt="${primary_home_field4}" src="${primary_home_field5}" /></a></div>\n<div id="hpmobile"><a onclick="s_objectID='Shop Banner Slot ${primary_home_field1}';" href="${primary_home_field2}?utm_source=banner&amp;utm_medium=int&amp;utm_campaign=${primary_home_field3}&amp;utm_content=shoptop&amp;utm_term=slot${primary_home_field1}"> <img alt="${primary_home_field4}" src="${primary_home_field6}" /></a></div>\n</div>\n\n\n<!-- ES Primary Banner -->\n<div class="item" region_id="Shop Banner Slot ${primary_home_field1}">\n<div id="hpdesk"><a onclick="s_objectID='Shop Banner Slot ${primary_home_field1}';" href="${primary_home_updatedUrl}?utm_source=banner&amp;utm_medium=int&amp;utm_campaign=${primary_home_field3}&amp;utm_content=esshoptop&amp;utm_term=slot${primary_home_field1}&amp;langId=es"><img alt="${primary_home_field4}" src="${primary_home_field5}" /></a></div>\n<div id="hpmobile"><a onclick="s_objectID='Shop Banner Slot ${primary_home_field1}';" href="${primary_home_updatedUrl}?utm_source=banner&amp;utm_medium=int&amp;utm_campaign=${primary_home_field3}&amp;utm_content=esshoptop&amp;utm_term=slot${primary_home_field1}&amp;langId=es"><img alt="${primary_home_field4}" src="${primary_home_field6}" /></a></div>\n</div>\n`;
    ...
    const primary_home_code = `<!-- EN Primary Banner -->\n<div class="item" region_id="Shop Banner Slot ${primary_home_field1}">\n<div id="hpdesk"><a onclick="s_objectID='Shop Banner Slot ${primary_home_field1}';" href="${primary_home_field2}?utm_source=banner&amp;utm_medium=int&amp;utm_campaign=${primary_home_field3}&amp;utm_content=shoptop&amp;utm_term=slot${primary_home_field1}"> <img alt="${primary_home_field4}" src="${primary_home_field5}" /></a></div>\n<div id="hpmobile"><a onclick="s_objectID='Shop Banner Slot ${primary_home_field1}';" href="${primary_home_field2}?utm_source=banner&amp;utm_medium=int&amp;utm_campaign=${primary_home_field3}&amp;utm_content=shoptop&amp;utm_term=slot${primary_home_field1}"> <img alt="${primary_home_field4}" src="${primary_home_field6}" /></a></div>\n</div>\n\n\n<!-- ES Primary Banner -->\n<div class="item" region_id="Shop Banner Slot ${primary_home_field1}">\n<div id="hpdesk"><a onclick="s_objectID='Shop Banner Slot ${primary_home_field1}';" href="${primary_home_updatedUrl}?utm_source=banner&amp;utm_medium=int&amp;utm_campaign=${primary_home_field3}&amp;utm_content=esshoptop&amp;utm_term=slot${primary_home_field1}&amp;langId=es"><img alt="${primary_home_field4}" src="${primary_home_field7}" /></a></div>\n<div id="hpmobile"><a onclick="s_objectID='Shop Banner Slot ${primary_home_field1}';" href="${primary_home_updatedUrl}?utm_source=banner&amp;utm_medium=int&amp;utm_campaign=${primary_home_field3}&amp;utm_content=esshoptop&amp;utm_term=slot${primary_home_field1}&amp;langId=es"><img alt="${primary_home_field4}" src="${primary_home_field8}" /></a></div>\n</div>\n`;
    document.getElementById('primary_home_output').textContent = primary_home_code;
