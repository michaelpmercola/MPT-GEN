...
if (global_thin_lang2) {
    ...
    const global_thin_code = `<!--------------------TOP THIN EN---------------------->\n<div class="top-thin-global-banner"><div id="hpdesk" region_id="top banner"><a href="${global_thin_field1}?cid_source=banner&amp;cid_medium=int&amp;cid=${global_thin_field2}&amp;cid_content=shopthin"> <img alt="${global_thin_field3}" src="${global_thin_field4}" /> </a></div>\n<div id="hpmobile" region_id="top banner"><a href="${global_thin_field1}?cid_source=banner&amp;cid_medium=int&amp;cid=${global_thin_field2}&amp;cid_content=shopthin"> <img alt="${global_thin_field3}" src="${global_thin_field5}" /> </a></div></div>\n<style>#hpdesk { display: block; } #hpmobile, .categorybannerimg { display: none; } @media only screen and (max-width: 769px) { #hpdesk { display: none; } #hpmobile { display: block; } }</style>\n\n<!--------------------TOP THIN ES---------------------->\n<div class="top-thin-global-banner"><div id="hpdesk" region_id="top banner"><a href="${global_thin_field1}?cid_source=banner&amp;cid_medium=int&amp;cid=${global_thin_field2}&amp;cid_content=esshopthin&amp;langId=es"> <img alt="${global_thin_field3}" src="${global_thin_field4}" /> </a></div>\n<div id="hpmobile" region_id="top banner"><a href="${global_thin_field1}?cid_source=banner&amp;cid_medium=int&amp;cid=${global_thin_field2}&amp;cid_content=esshopthin&amp;langId=es"> <img alt="${global_thin_field3}" src="${global_thin_field5}" /> </a></div></div>\n<style>#hpdesk { display: block; } #hpmobile, .categorybannerimg { display: none; } @media only screen and (max-width: 769px) { #hpdesk { display: none; } #hpmobile { display: block; } }</style>\n\n\n<!--------------------TOP THIN LP EN---------------------->\n<script data-cfasync="false" type="text/javascript">var elmshpdesk = document.querySelectorAll("[id='hpdesk']"); for(var i = 0; i < elmshpdesk.length; i++) elmshpdesk[i].innerHTML = '<img alt="${global_thin_field3}" src="${global_thin_field4}">'; var elmshpmobile = document.querySelectorAll("[id='hpmobile']"); for(var i = 0; i < elmshpmobile.length; i++) elmshpmobile[i].innerHTML = '<img alt="${global_thin_field3}" src="${global_thin_field5}">';</script>\n`;
    ...
    const global_thin_code = `<!--------------------TOP THIN EN---------------------->\n<div id="hpdesk" region_id="top banner"><a href="${global_thin_field1}?cid_source=banner&amp;cid_medium=int&amp;cid=${global_thin_field2}&amp;cid_content=shopthin"> <img alt="${global_thin_field3}" src="${global_thin_field4}" /> </a></div>\n<div id="hpmobile" region_id="top banner"><a href="${global_thin_field1}?cid_source=banner&amp;cid_medium=int&amp;cid=${global_thin_field2}&amp;cid_content=shopthin"> <img alt="${global_thin_field3}" src="${global_thin_field5}" /> </a></div>\n<style>#hpdesk { display: block; } #hpmobile, .categorybannerimg { display: none; } @media only screen and (max-width: 769px) { #hpdesk { display: none; } #hpmobile { display: block; } }</style>\n\n<!--------------------TOP THIN ES---------------------->\n<div id="hpdesk" region_id="top banner"><a href="${global_thin_field1}?cid_source=banner&amp;cid_medium=int&amp;cid=${global_thin_field2}&amp;cid_content=esshopthin&amp;langId=es"> <img alt="${global_thin_field3}" src="${global_thin_field6}" /> </a></div>\n<div id="hpmobile" region_id="top banner"><a href="${global_thin_field1}?cid_source=banner&amp;cid_medium=int&amp;cid=${global_thin_field2}&amp;cid_content=esshopthin&amp;langId=es"> <img alt="${global_thin_field3}" src="${global_thin_field7}" /> </a></div>\n<style>#hpdesk { display: block; } #hpmobile, .categorybannerimg { display: none; } @media only screen and (max-width: 769px) { #hpdesk { display: none; } #hpmobile { display: block; } }</style>\n\n\n<!--------------------TOP THIN LP EN---------------------->\n<script data-cfasync="false" type="text/javascript">var elmshpdesk = document.querySelectorAll("[id='hpdesk']"); for(var i = 0; i < elmshpdesk.length; i++) elmshpdesk[i].innerHTML = '<img alt="${global_thin_field3}" src="${global_thin_field4}">'; var elmshpmobile = document.querySelectorAll("[id='hpmobile']"); for(var i = 0; i < elmshpmobile.length; i++) elmshpmobile[i].innerHTML = '<img alt="${global_thin_field3}" src="${global_thin_field5}">';</script>\n\n<!--------------------TOP THIN LP ES---------------------->\n<script data-cfasync="false" type="text/javascript">var elmshpdesk = document.querySelectorAll("[id='hpdesk']"); for(var i = 0; i < elmshpdesk.length; i++) elmshpdesk[i].innerHTML = '<img alt="${global_thin_field3}" src="${global_thin_field6}">'; var elmshpmobile = document.querySelectorAll("[id='hpmobile']"); for(var i = 0; i < elmshpmobile.length; i++) elmshpmobile[i].innerHTML = '<img alt="${global_thin_field3}" src="${global_thin_field7}">';</script>\n`;
    document.getElementById('global_thin_output').textContent = global_thin_code;
